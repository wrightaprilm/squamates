...
library(diversitree)
library(ape)
#For this analysis, we use a data file that's been made a little smaller than the 8000-taxon data set
...
#File currently set up to run in working directory, could easily be amended, but I hate R
